    ...
    <div className="vf-fadein">
      ...
      <div className="p-4 md:p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <Card className="p-4"><div className="text-xs text-[var(--vf-text2)] uppercase">Alertas insumos</div><div className={`text-2xl font-semibold ${criticos ? 'text-[var(--vf-error)]' : 'text-[var(--vf-success)]'}`}>{criticos}</div></Card>
          <Card className="p-4"><div className="text-xs text-[var(--vf-text2)] uppercase">Produtos críticos</div><div className={`text-2xl font-semibold ${produtosCriticos ? 'text-[var(--vf-error)]' : 'text-[var(--vf-success)]'}`}>{produtosCriticos}</div></Card>
        </div>

    ...
    <div className="vf-fadein">
      ...
      <div className="p-4 md:p-6 space-y-5">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <Card className="p-4"><div className="text-[10px] uppercase text-[var(--vf-text3)] tracking-wide">Ativas</div><div className="text-2xl text-[var(--vf-success)] font-semibold">{resumo.ativas}</div></Card>
          <Card className="p-4"><div className="text-[10px] uppercase text-[var(--vf-text3)] tracking-wide">No cardápio</div><div className="text-2xl text-[var(--vf-info)] font-semibold">{resumo.cardapio}</div></Card>
        ...
        {isLoading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            {promocoes!.map(p => {
              ...
              return (
                <Card key={p.id} className="p-4 hover:border-[color-mix(in_srgb,var(--vf-secondary)_42%,transparent)] transition-colors">
                  ...
                  <div className="grid grid-cols-3 gap-2 mb-3">
                    ...
                    <div className="bg-[color-mix(in_srgb,var(--vf-success)_8%,transparent)] rounded-lg p-2"><div className="text-[9px] text-[var(--vf-text3)] uppercase">Promo</div><div className="text-[12px] text-[var(--vf-success)] font-semibold">{fmtCurrency(p.preco_promocional)}</div></div>
                    <div className="bg-[color-mix(in_srgb,var(--vf-secondary)_10%,transparent)] rounded-lg p-2"><div className="text-[9px] text-[var(--vf-text3)] uppercase">Economia</div><div className="text-[12px] text-[var(--vf-primary)] font-semibold">{fmtPct(pct)}</div></div>
                  </div>

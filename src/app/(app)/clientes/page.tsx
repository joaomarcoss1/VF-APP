  ...
  return <div className="vf-fadein">
    ...
    <div className="p-4 md:p-6 space-y-5">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        ...
        <Card className="p-4"><div className="text-xs text-[var(--vf-text2)] uppercase">Com WhatsApp</div><div className="text-2xl text-[var(--vf-primary)] font-semibold">{stats.whatsapp}</div></Card>
        <Card className="p-4"><div className="text-xs text-[var(--vf-text2)] uppercase">Leads</div><div className="text-2xl text-[var(--vf-success)] font-semibold">{stats.leads}</div></Card>
      </div>

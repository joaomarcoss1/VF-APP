...
export default function OnboardingPage() {
  ...
  return (
    <div className="min-h-full bg-[radial-gradient(circle_at_top_left,var(--vf-accent-soft),transparent_30%),var(--vf-bg)] p-4 md:p-8 flex items-center justify-center">
      <Card className="w-full max-w-4xl overflow-hidden" gold>
        <div className="grid grid-cols-1 lg:grid-cols-[0.9fr_1.1fr]">
          <div className="p-6 md:p-8 border-b lg:border-b-0 lg:border-r border-[color-mix(in_srgb,var(--vf-primary)_18%,transparent)] bg-[var(--vf-surface)]">

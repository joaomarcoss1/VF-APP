...
export const ROLE_PERMISSIONS: Record<CargoEquipe, PermissaoChave[]> = {
  ...
  gerente: [
    ...leituraGeral,
    'produtos:criar','produtos:editar','vendas:criar','vendas:editar','vendas:cancelar','vendas:estornar','clientes:criar','clientes:editar','estoque:criar','estoque:editar','financeiro:criar','financeiro:editar','relatorios:exportar','agendamentos:criar','agendamentos:editar','ordens-servico:criar','ordens-servico:editar','ordens-servico:aprovar','comprovantes:criar','fechamento:criar','despesas:criar','despesas:editar','equipe:ver','auditoria:ver'
  ],
  financeiro: [
  ...
  vendedor: [
    'dashboard:ver','produtos:ver','vendas:ver','vendas:criar','clientes:ver','clientes:criar','clientes:editar','comprovantes:ver','comprovantes:criar','cardapio:ver','promocoes:ver'
  ],
  atendente: [
    'dashboard:ver','clientes:ver','clientes:criar','clientes:editar','agendamentos:ver','agendamentos:criar','agendamentos:editar','vendas:ver','vendas:criar','comprovantes:ver','comprovantes:criar','produtos:ver','cardapio:ver'
  ],
  operacional: [
    'dashboard:ver','produtos:ver','estoque:ver','estoque:criar','estoque:editar','notas-fiscais:ver','notas-fiscais:criar','fornecedores:ver','fornecedores:criar','agendamentos:ver','ordens-servico:ver','ordens-servico:criar','ordens-servico:editar','insumos:ver','insumos:criar','insumos:editar','fichas:ver'
  ],
  contador: [

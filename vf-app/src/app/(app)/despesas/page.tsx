  ...
  return (
    <div className="vf-fadein">
      ...
      <div className="p-4 md:p-6 space-y-5">
        ...
        {error && <Card className="p-4 text-[#D45050]">{(error as Error).message}</Card>}
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <Card className="p-4"><span className="text-[10px] text-[var(--vf-text3)] uppercase">Variáveis/outros</span><div className="text-xl text-[#4A8FD4] font-semibold">{fmtCurrency(resumo.variaveis)}</div></Card>
          <Card className="p-4"><span className="text-[10px] text-[var(--vf-text3)] uppercase">Despesas ativas</span><div className="text-xl text-[#3DAA6B] font-semibold">{resumo.count}</div></Card>
        </div>

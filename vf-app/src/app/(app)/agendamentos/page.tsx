    ...
    <div className="vf-fadein">
      ...
      <div className="p-4 md:p-6 space-y-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <Card className="p-4"><div className="text-xs text-[var(--vf-text2)] uppercase">Receita prevista</div><div className="text-2xl text-[#3DAA6B] font-semibold">{fmtCurrency(proximos.reduce((a,b)=>a+Number(b.total||0),0))}</div></Card>
